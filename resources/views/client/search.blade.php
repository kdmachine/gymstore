...
@section('client_head')
    ...
    <!-- SITE TITLE -->
    <title>{{ hwa_page_title($result['keyword'] ?? "Tìm kiếm sản phẩm") }}</title>
@endsection
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="page-title">
                        <h1>{{ $result['keyword'] ?? "Tìm kiếm sản phẩm" }}</h1>
                    </div>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb justify-content-md-end">
                        <li class="breadcrumb-item"><a href="{{ route('client.home') }}">Trang chủ</a></li>
                        <li class="breadcrumb-item active">{{ $result['keyword'] ?? "Tìm kiếm sản phẩm" }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- END CONTAINER-->
