                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td align="center" valign="middle" style="padding-top: 30px; padding-bottom: 30px;"
                                    class="emailLogo">
                                    <a href="{{ route('admin.home') }}" style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';color:#3d4852;font-size:19px;font-weight:bold;text-decoration:none;display:inline-block" target="_blank">
                                        {{ hwa_app_name() }}
                                    </a>
                                </td>
                            </tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td align="left" valign="top"
                                    ...
                                    class="mainTitle">
                                    <h1 style="color:#495057;font-family:'Open Sans', Helvetica, Arial, sans-serif;font-size:28px;font-weight:600;line-height:1.5;text-align:center!important; margin: 50px 0 50px;"
                                        align="center">Đặt lại mật khẩu thành công!</h1>
                                    <p class="text"
                                       style="color: #868e96; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:16px; font-weight:400; font-style:normal; letter-spacing:normal; line-height: 1.5; text-transform:none; text-align:left; padding:0; margin:0 0 15px;">
                                        Hi <b>{{ $data['first_name'] ?? 'You'}}</b>,
                                    </p>
                                    <p class="text"
                                       style="color: #868e96; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:16px; font-weight:400; font-style:normal; letter-spacing:normal; line-height: 1.5; text-transform:none; text-align:left; padding:0; margin:0 0 15px;">
                                        Mật khẩu {{ hwa_app_name() }} của bạn đã được thay đổi:
                                    </p>
                                    <p class="text"
                                       style="color: #868e96; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:16px; font-weight:400; font-style:normal; letter-spacing:normal; line-height: 1.5; text-transform:none; text-align:center; padding:0; margin:0 0 15px;">
                                        <b>{{ $data['updated_at'] }}</b>
                                    </p>
                                </td>
                            </tr>
                                    ...
                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                        ...
                                        <tr>
                                            <td align="left" valign="top" style="padding-bottom: 5px;">
                                                <p class="text"
                                                   style="color: #868e96; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:16px; font-weight:400; font-style:normal; letter-spacing:normal; line-height: 1.5; text-transform:none; text-align:left; padding:0; margin:0 0 15px;">
                                                    Nếu bạn không làm điều này, vui lòng liên hệ với <a href="mailto:{{ hwa_app_contact() }}" style="text-decoration: none;">quản trị viên</a>.
                                                </p>
                                            </td>
                                        </tr>
                                        </tbody>
                                ...
                                <td align="center" valign="top" style="padding: 5px 10px 10px;" class="footerEmailInfo">
                                    <p class="text"
                                       style="color:#868e96; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:20px; text-transform:none; text-align:center; padding:0; margin:0;">
                                        Tin nhắn này đã được gửi đến <a href="mailto:{{ $data['email'] }}" style="text-decoration:none;" target="_blank">{{ $data['email'] }}</a> như bạn yêu cầu.
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <td align="center" valign="top" style="padding: 5px 10px 10px;" class="footerEmailInfo">
                                    <p class="text"
                                       style="color:#868e96; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:20px; text-transform:none; text-align:center; padding:0; margin:0;">
                                        Nếu bạn có câu hỏi nào, liên hệ <a href="mailto:{{ hwa_app_contact() }}"
                                                                                     style="text-decoration:none;"
                                                                                     target="_blank">{{ hwa_app_contact() }}.</a><br>
                                    </p>
                                </td>
                            </tr>
