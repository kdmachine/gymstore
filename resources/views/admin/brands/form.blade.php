...
@section('admin_head')
    <title>{{ hwa_page_title( isset($result) ? ($result['name'] ?? "Cập nhật thương hiệu") : "Thêm thương hiệu" ) }}</title>
    <meta
        content="{{ hwa_page_title( isset($result) ? ($result['name'] ?? "Cập nhật thương hiệu") : "Thêm thương hiệu") }}"
        name="description"/>
@endsection
@section('admin_style')
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route("{$path}.index") }}">Thương hiệu</a>
                            </li>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="description" cols="30" rows="4"
                                              ...
                                              placeholder="Nhập mô tả thương hiệu">{{ old('description') ?? (isset($result['description']) ? $result['description'] : '') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="dropify"
                                           name="image" {{ (isset($result['images']) && !empty($result['images'])) ? 'data-default-file=' . hwa_image_url("brands", $result['images']) : "" }}>
                                    @if($errors->has('image'))
