...
@section('admin_head')
    <title>{{ hwa_page_title("Thương hiệu") }}</title>
    <meta content="{{ hwa_page_title("Thương hiệu") }}" name="description"/>
@endsection
                    ...
                    <div class="card-body">
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap"
                            ...
                            <tr>
                                ...
                                @canany(['edit_brand', 'delete_brand'])
                            ...
                            @foreach($results as $result)
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <img
                                            src="{{ !empty($result['images']) ? hwa_image_url('brands', $result['images']) : '' }}"
