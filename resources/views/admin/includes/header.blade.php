            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="{{ route('admin.auth.profile.index') }}"><i
                            class="bx bx-user font-size-16 align-middle me-1"></i> <span>Cá nhân</span></a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item text-danger" href="{{ route('admin.auth.logout') }}"><i
                            class="bx bx-power-off font-size-16 align-middle me-1 text-danger"></i> <span>Đăng xuất</span></a>
                </div>
            </div>
        </div>
    </div>
