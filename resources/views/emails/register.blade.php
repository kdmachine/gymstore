                                ...
                                <td align="left" valign="top"
                                    ...
                                    <p class="text"
                                       style="color: #868e96; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:16px; font-weight:400; font-style:normal; letter-spacing:normal; line-height: 1.5; text-transform:none; text-align:left; padding:0; margin:0 0 15px;">
                                        Chào <b>{{ $data['first_name'] ?? 'Bạn'}}</b>,
                                    </p>
                                    <p class="text"
                                       style="color: #868e96; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:16px; font-weight:400; font-style:normal; letter-spacing:normal; line-height: 1.5; text-transform:none; text-align:left; padding:0; margin:0 0 15px;">
                                        Chúc mừng bạn đã đăng ký thành công tại {{ hwa_app_name() }}.
                                    </p>
                                    <p class="text"
                                       style="color: #868e96; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:16px; font-weight:400; font-style:normal; letter-spacing:normal; line-height: 1.5; text-transform:none; text-align:left; padding:0; margin:0 0 15px;">
                                        Thông tin tài khoản:
                                    ...
                                    <p class="text"
                                       style="color: #868e96; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:16px; font-weight:400; font-style:normal; letter-spacing:normal; line-height: 1.5; text-transform:none; text-align:left; padding:0; margin:0 0 15px;">
                                        ...
                                        Mật khẩu: <strong>{{ $data['password'] ?? "Password"}}</strong>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                        ...
                                        <tr>
                                            <td align="center" class="ctaButton" style="padding-bottom: 25px;">
                                                <p style="display: inline-block;">
                                                    <a class="text" href="{{ route('client.home') }}" target="_blank"
                                        ...
                                        <tr>
                                            <td align="left" valign="top" style="padding-bottom: 5px;">
                                                <p class="text"
                                                   style="color: #868e96; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:16px; font-weight:400; font-style:normal; letter-spacing:normal; line-height: 1.5; text-transform:none; text-align:left; padding:0; margin:0 0 15px;">
                                                    Đường dẫn đăng nhập {{ hwa_app_name() }}: <a href="{{ route('client.auth.login') }}"
                                                                                                    style="color:#868e96;text-decoration:none"><strong>{{ route('client.auth.login') }}</strong></a>
                                                </p>
                                            </td>
                                        </tr>
                                        </tbody>
