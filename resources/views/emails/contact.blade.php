                            ...
                            <tr>
                                <td align="left" valign="top"
                                    ...
                                    <h1 style="color:#495057;font-family:'Open Sans', Helvetica, Arial, sans-serif;font-size:32px;font-weight:600;line-height:1.5;text-align:center!important; margin: 50px 0 50px;"
                                        align="center">Liên hệ mới</h1>
                                    <h4 style="color:#495057;font-family:'Open Sans', Helvetica, Arial, sans-serif;font-size:16px;font-weight:600;line-height:1.5;text-align:left!important; margin: 30px 0 30px;">{{ $contact['subject'] ?? "Chủ đề" }}</h4>
                                    <p class="text"
