...
class LoginController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        if ($request->getMethod() == 'GET') {
            ...
            if ($validator->fails()) {
                ...
                hwa_notify_error($validator->getMessageBag()->first(), ['top' => true, 'title' => 'Thất bại!']);
                ...
                if ($checkExisted && $checkExisted->active == 1) {
                    ...
                    if (auth()->guard('admin')->attempt($credentials, $remember)) {
                        ...
                        // Wrong password
                        hwa_notify_error("Mật khẩu không đúng.", ['top' => true]);
    ...
    public function logout()
    {
        ...
        hwa_notify_success("Đăng xuất thành công.", ['top' => true]);
